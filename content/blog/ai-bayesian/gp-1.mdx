...
sidenotes: [
  {
    id: 1,
    content: "바로 다음에 어떤 값을 가질지 확률로 정해지기 때문."
  },
  {
    id: 2,
    content: "그 시점들이 연속적일 필요는 없다. 물론, 순서도 상관없다."
  }
]
---
...
![cover-stock](../../image/cover-stock.png)

어떤 한 시점에서 주가는 <Sidenote id={1}>확률변수</Sidenote>이다.
...
자, 앞서 말한 주가 이야기로 한번 돌아가보자. 우리는 현재 $t_1, \cdots, t_N$ <Sidenote id={2}>시점</Sidenote>에서의 주가를 알고 있다. \
