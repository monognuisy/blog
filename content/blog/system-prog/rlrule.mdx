...
1. <span style={textHighlightBlue}>**식별자**를 찾는다.</span>
...
2. <span style={textHighlightBlue}>**오른쪽으로 이동!**</span>
...
3. <span style={textHighlightBlue}>**왼쪽으로 이동!**</span>
...
3. **왼쪽으로 이동!**
   ...
   1. 왼쪽으로 이동한다. `*`가 보인다.
      ...
      즉, <Code>“p is array of **pointer to**”</Code>
   ...
   2. 왼쪽으로 이동한다. `int`가 보인다.
      ...
      즉, <Code>“p is array of pointer to **int**”</Code>
...
2. **오른쪽으로 이동!**
   ...
   1. 한 번 이동하면 `()`가 나온다.
      ...
      즉, <Code>“func is **function returning**”</Code>
...
3. **왼쪽으로 이동!**
   ...
   1. 식별자 왼쪽에 `*`가 있다.
      ...
      즉, <Code>“func is function returning **pointer to**”</Code>
...
4. **오른쪽으로 이동!**
   ...
   1. 앞서 멈춘 쪽에서 오른쪽으로 가면 `()`가 나온다.
      ...
      즉, <Code>“func is function returning pointer to **function returning**”</Code>
...
5. **왼쪽으로 이동!**
   ...
   1. 앞서 멈춘 쪽에서 왼쪽으로 가면 `*`가 나온다.
      ...
      즉, <Code>“func is function returning pointer to function returning **pointer to**”</Code>
   ...
   2. 한번 더 가면 `int`가 나온다.
      ...
      즉, <Code>“func is function returning pointer to function returning pointer to **int**”</Code>
...
<Code>“sighandler_t is **type which is** pointer to function expecting (int) returning void“</Code>

한국어로 번역하면,

<Code>“sighandler_t는 void를 반환하는 (int를 매개변수로 하는) 함수의 포인터**를 나타내는 타입이다**”</Code>
